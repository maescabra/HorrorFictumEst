...
const storylist = [
    {
      ...
      texte:<p> Test 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrage Test 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrage Test 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrageTest 1 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrage </p>,
    },
    {
      genres: [
        paranormal,
    ...
    },
    {
      ...
      <p>
        ...
        Je suis rentrée avec Ange il y a quelques heures de cela. Je vais tenter de partager mon ressenti sur cette journée, mais je ne pourrai pas correctement décrire ce que j'ai vécu, car je ne sais pas ce que j'ai vécu. J'ai eu une sorte... d'absence. Je me souviens de m'être réveillée ce matin, d'avoir déjeuné un bol de Coco Pops et de m'être préparée, mais après avoir franchi le seuil de la porte... plus rien. Je n'en ai aucun souvenir...<br/>
        Si. Je me souviens qu'après ça j'étais dans la boutique. J'étais en train de servir un client, et il m'a demandé si ça allait. J'ai dû lui redemander ce qu'il voulait car je ne me souvenais de rien. <br/>
        Après le boulot j'ai récupéré Ange et en rentrant, j'ai remarqué qu'elle s'est regardée assez longtemps le miroir dans l'entrée pour la troisième fois depuis hier. Je pense qu'elle découvre son reflet.<br/>
        ...
        J'ai peur du noir... je n'arrive plus à respirer... Les choux-fleurs sont partout sur les murs et une araignée géante me fixe depuis tout à l'heure...<br/>
        Maman...
        ...
        Je viens de me réveiller. Je ne comprends pas ce que j'ai discerné dans l'obscurité. Une silhouette humanoïde avec des cornes de bouc en affrontait une autre aux échecs dans notre chambre parentale. L'une des deux a retourné l'échiquier puis les deux ont disparu, l'échiquier aussi... À examiner...<br/>

        <h3>16.03.2020 à 20h21</h3>

        Cher journal,<br/><br/>

        Je ne sais pas quoi dire...<br/>
        Comment résumer cela en quelques mots ? Je ne sais pas. Je ne sais plus. J'aurais dû réussir cette satanée TS. Pourquoi faire tout ce chemin... pour ÇA ?!<br/>
        ...
        Après m'être frayé un passage vers la vitrine, j'ai enfin pu voir sans mal l'objet de toutes les frayeurs. Dans la vitrine était exposé un grand bouquet rouge, qui s'avérait être composé de morceaux de chair et de peau humaines, mais également d'organes. Les "fleurs" étaient liées par ce qui semblait être des parties d'intestin et je pus distinguer une main, ce qui me fit tourner la tête de terreur et de dégoût. En ayant toujours le regard éloigné de ces monstruosités, je ne pus m'empêcher de poser une question à laquelle je ne voulais pas savoir la réponse. Comme je le craignais, cette main gauche portait une bague avec une pierre d'améthyste en forme de papillon...<br/>

        Il... s'agissait... de la main... de ma femme... Nadège... alors cela signifie-t-il que les intestins et la chair étaient les siens ? <br/>

        Je ne sais pas comment je vais l'apprendre à Ange... Mon dieu... Elle pense que sa mère est partie pour le travail...<br/>

        <h3>17.03.2020 à 6h08</h3>

        Cher journal,<br/><br/>

        Je n'ai pas dormi, mais je n'ai pas pu me résoudre à écrire... je ne peux pas mettre de mots sur l'horreur que je vis actuellement...<br/>

        J'ai encore espoir que quelqu'un lui ait volé sa bague avant de mourir...<br/>

        Ses bras me manquent tellement...<br/>
        ...
        Des policiers se sont rendus chez moi pour m'annoncer que le corps de ma femme avait été identifié... en morceaux...<br/>
        ...
        J'écris vite, je n'ai pas le temps car je dois aller au travail et je me suis réveillée en retard.<br/>
        ...
        Rendez-moi ma femme... Je te vengerai Nadège...<br/>

        Les laboratoires sont-ils aussi responsables de ta mort ??!<br/>
        ...
        J'ai quitté mon travail. Je ne pouvais pas supporter de retourner là où ma vie s'était écroulée.<br/>
        ...
        <h3>Bien #7384209<br/>
        Objet : Journal du patient 44-10</h3>

        ---

        <h3>Patient 44-10</h3>

        <h3>Nom du patient : Clotilde SATURNIN<br/>
    ...
    },
    {
      ...
      title:"Murder",
      image:"/assets/stories/easystreet.png",
      texte:<p> Test 4 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrage </p>,
    },
    {
      genres: [
        paranormal,
      ...
      title:"Colère",
      image:"/assets/stories/easystreet.png",
      texte:<p> Test 5 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrage </p>,
    },
    {
      genres: [
        crime
      ...
      title:"Miséricorde",
      image:"/assets/stories/easystreet.png",
      texte:<p> Test 6 "Lorem ipsum dolores ombrage Lorem ipsum dolores ombrage </p>,
    },
  ];
